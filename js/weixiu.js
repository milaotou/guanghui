$(function(){
	...
	$(".xyb").click(function(){
		var ac= $(".maintain_list li .list_5").length;
		var ad= $(".maintain_list li .dian_h").length;
		if (ac>ad) {
			$(".maintain_btn_tip").fadeOut();
...
$(function(){
	// 预约维修选定项目验证
    $(".maintain_list li .list_5,.list_2 b").click(function(){
        $(".maintain_btn_tip").fadeOut();
    });
    // 预约维修预约时间验证
